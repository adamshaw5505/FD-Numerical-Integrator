...
#define WEYL_RHS(u,u_rhs,I,DX,DY,DZ) u_rhs[0+I] = Base(3.0)*u[2+I]*(u[3+I]*u[3+I])*u[1+I] - (u[1+I]/(Base(2.0)*u[0+I]))*((Base(1)-u[3+I]*u[3+I])*DX(u,5+I,dx)-Base(2.0)*u[3+I]*u[5+I]*DX(u,3+I,dx));\
                                     u_rhs[1+I] = 0;\
                                     ...
                                     u_rhs[4+I] = 0;\
                                     u_rhs[5+I] = (u[1+I]/(Base(2.0)*u[0+I]))*( (u[3+I]*u[3+I] - Base(1))*DX(u,0+I,dx) -Base(2.0)*u[4+I]*u[3+I]*u[3+I]*u[5+I]) - Base(3.0)*u[3+I]*u[1+I]*DX(u,3+I,dx);
